...
import Style from './Navb.module.scss';
...
const Navbar = () => {
  ...
  return (
    <nav className={`${Style.navBar} ${!isNavCollapsed ? '' : 'border-b'}`}>
      ...
      <div className={Style.navBarCollapse} id='navbarNav'>
        <ul className={Style.navBarCollapseNav}>
          ...
          <li className={'nav-item'}>
            <NavLink className={Style.navLink} ref={li} to='/projets'>
              <div className={Style.original}>
                <span>p</span>
                <span>r</span>
                <span>o</span>
          ...
          <li className={'nav-item'}>
            <NavLink className={Style.navLink} ref={li} to='/contacte'>
              <div className={Style.original}>
                <span>c</span>
                <span>o</span>
                <span>n</span>
